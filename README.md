...
🔗 **Live Demo:** [slateassist-live-demo.vercel.app](https://ai-realtime-collaborative-code-edit.vercel.app/) 🌐
...
<p align="center">
  ...
  <details>
    ...
    <img src="./client/src/assets/img/ps_run.png" alt="SlateAssist Screenshot 5" width="49%">
    <img src="./client/src/assets/img/ps_ai.png" alt="SlateAssist Screenshot 6" width="49%">
    <br>
  </details>
</p>
...
* **⚙️ In-Browser Compilation & Execution:** Turn your code into reality with our integrated C++ execution engine! Send your code to the robust Judge0 API for compilation and instant execution.
...
* **📜 Ready-to-Code Boilerplate:** New coding rooms come pre-loaded with a basic C++ structure, so you can jump straight into writing code without any setup!
...
* **Backend (Node.js + Express):** A robust and scalable backend built on Node.js with the Express.js framework. It handles all API requests, manages WebSocket connections, enforces authentication, and acts as a secure intermediary for communicating with third-party AI and code execution services.
...
* **Real-time Communication (Socket.IO):** The heart of SlateAssist's collaborative features! Socket.IO provides a persistent, low-latency WebSocket connection for seamless, bi-directional communication between the frontend and backend.
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/Swaymbhu-git/SlateAssist.git
   cd SlateAssist
   ```
...
* **Frontend:** Deployed with the speed and simplicity of **[Vercel](https://vercel.com/)**.
* **Backend:** Running smoothly on the reliable infrastructure of **[Render](https://render.com/)**.
